                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-lg-12">
                            <div class="section-title newslater-title">
                                <div class="icon">
                                    <img src="{{ asset('web/images/sncraipur.jpeg') }}" alt="img">
                                </div>                                
                            </div>
                        </div>
                            ...
                            <div class="footer-widget mb-30">
                                ...
                                <div class="f-contact">
                                    ...
                                    <li>
                                        ...
                                        <a style="margin-left:54px;" href="tel:+917828168418">+91 78281 68418</a><br>
                                   ...
                                   <li><i class="icon fal fa-envelope"></i>
                                    ...
                                    <li>
                                        ...
                                        <span>Ring Road No.1, Near Pani Tanki,<br> Changorbhatha, Raipur, Chhattisgarh, 492001 </span>
                                    </li>
